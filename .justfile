...
# Regenerate .sops.yaml from publicKeys/*.pub, then re-encrypt every
...
sops-rekey:
    ...
    set -euo pipefail
    shopt -s nullglob
    user_pubs=(publicKeys/aly_*.pub)
    host_pubs=(publicKeys/root_*.pub)
    {
        cat <<'EOF'
    # Auto-generated by `just sops-rekey` from publicKeys/*.pub.
